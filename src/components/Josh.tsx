...
Command: npx gltfjsx@6.1.4 josh_3.glb --types
*/
...
const Josh = (props: JSX.IntrinsicElements['group']) => {
  const { nodes, materials } = useGLTF('./models-3d/josh_3.glb') as GLTFResult
  return (
...
useGLTF.preload('./models-3d/josh_3.glb')
